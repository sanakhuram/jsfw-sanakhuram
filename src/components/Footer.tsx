    ...
    <footer className="bg-red-900 text-orange-300 py-10 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="space-y-3 text-center md:text-left">
          <Link
            href="/"
            className="text-xl font-bold flex justify-center md:justify-start items-center space-x-2"
          >
            <Image src="/images/logo.png" alt="Vibe Cart Logo" width={80} height={80} />
          </Link>
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="flex space-x-4">
            ...
            <Link
              href="https://www.instagram.com/sana_khuram/?igsh=MTBneHhvd2d2eXB2dg%3D%3D#"
              target="_blank"
              rel="noopener"
              className="hover:opacity-75"
            >
          ...
          <p className="text-sm text-center text-orange-200 max-w-xs">
            At Vibe Cart, we blend trend with trust. Discover quality products at unbeatable prices,
            delivered with care.
          </p>
        ...
        <div className="space-y-3 text-center md:text-right">
          <nav className="flex flex-col space-y-2">
            ...
            <Link href="/services/privacy-policy" className="hover:underline">
              Privacy Policy
            </Link>
            <Link href="/services/terms-of-service" className="hover:underline">
              Terms of Service
            </Link>
          </nav>
        </div>
